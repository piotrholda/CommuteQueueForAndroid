...
public class NextToDriveTests {
    ...
    public void WhosNextTakeFirstInOrderWhenNoDrives(){
        ...
        //expected
        DrivingQueue expectedDrivers = new DrivingQueue(
                Observable.just(new Driver("PH"), new Driver("PA"), new Driver("PC")));
    ...
    public void WhosNextReturnsNoMileage() {
        ...
        //expected
        DrivingQueue expectedDrivers = new DrivingQueue(
                Observable.just(new Driver("PC"), new Driver("PA"), new Driver("PH")));
        assertEquals(expectedDrivers, drivingQueue);
    }
    ...
    public void NextReturnsInOrderWhenMileageEqual() {
        ...
        //expected
        DrivingQueue expectedDrivers = new DrivingQueue(
                Observable.just(new Driver("PA"),new Driver("PC"),new Driver("PH")));
        assertEquals(expectedDrivers, drivingQueue);
    }
}
